...
public class Class8901 {
   ...
   public Class8901(Vector3d var1, Vector3d var2) {
      this.field40284 = var1.add(0.0, 0.0, 0.0).floor();
      this.field40285 = var2.add(0.0, 0.0, 0.0).floor();
   }
   ...
   public void method32446(int var1, int var2) {
      ...
      this.field40288.add(new Class8534(this.field40284, null, var5, this.field40284.square(this.field40285), 0.0, 0.0));

      label72:
      for (int var6 = 0; var6 < var1; var6++) {
         Collections.sort(this.field40288, new Class3604(this));
         int var7 = 0;
         if (this.field40288.isEmpty()) {
            break;
         }

         for (Class8534 var9 : new ArrayList<>(this.field40288)) {
            if (++var7 <= var2) {
               this.field40288.remove(var9);
               this.field40287.add(var9);

               for (Vector3d var13 : field40292) {
                  Vector3d var14 = var9.method30354().add(var13).floor();
                  if (method32448(var14, false) && this.method32451(var9, var14, 0.0)) {
                     break label72;
                  }
               }

               Vector3d var15 = var9.method30354().add(0.0, 1.0, 0.0).floor();
               if (method32448(var15, false) && this.method32451(var9, var15, 0.0)) {
                  break label72;
               }

               Vector3d var16 = var9.method30354().add(0.0, -1.0, 0.0).floor();
   ...
   public static ArrayList<Vector3d> method32447(Vector3d vec1, Vector3d vec2) {
      ...
      for (Vector3d var12 : var10) {
         if (var6 != 0 && var6 != var10.size() - 1) {
            boolean var13 = true;
            if (!(var12.square(var8) > (double)(var5 * var5))) {
   ...
   public boolean method32451(Class8534 var1, Vector3d var2, double var3) {
      ...
      if (var7 != null) {
         if (var7.method30358() > var3) {
            ...
            var7.method30362(var2.square(this.field40285));
         ...
         if (var2.getX() == this.field40285.getX()
            ...
            || this.field40289 != 0.0 && var2.square(this.field40285) <= this.field40289) {
            this.field40286.clear();
         ...
         var10.add(var2);
         this.field40288.add(new Class8534(var2, var1, var10, var2.square(this.field40285), var3, var8));
      }
