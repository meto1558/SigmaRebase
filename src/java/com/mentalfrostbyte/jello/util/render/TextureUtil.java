...
public class TextureUtil {
    ...
    public static Texture method32935(String var0, BufferedImage var1, int var2, int var3, int var4, int var5) {
        ...
        ByteBuffer var13 = var8.imageToByteBuffer(var1, false, false, null);
        var11.setTextureHeight(var8.getTexHeight());
        var11.setTextureWidth(var8.getTexWidth());
        var11.setAlpha(var8.getDepth() == 32);
        if (var2 == 3553) {
