...
import com.mentalfrostbyte.jello.util.unmapped.Class8781;
...
public class InteractAutoBlock {
   ...
   public void block(Entity var1, float var2, float var3) {
      if (this.parent.getBooleanValueFromSettingName("Interact autoblock")) {
         EntityRayTraceResult var6 = RotationUtil.raytrace(
   ...
   public List<TimedEntity> method36823(float var1) {
      ...
      for (Entity ent : WorldUtil.getEntitesInWorld()) {
      ...
      while (entities.hasNext()) {
         ...
         if (ent == this.mc.player || ent == Blink.clientPlayerEntity) {
            ...
            Vector3d var10 = RotationUtil.method17751(ent);
            if (!(this.mc.player.getDistance(ent) < 40.0F)) {
               ...
               this.field44349.put(ent, new ArrayList<>());
            } else {
            ...
            if (!(RotationUtil.method17754(var10) > 8.0)) {
               boolean var26 = true;
               if (this.parent.getBooleanValueFromSettingName("Smart Reach")) {
                  ...
                  if (var27 != null) {
                     for (Class9629<Vector3d, Long> var30 : var27) {
                        ...
                        double var22 = RotationUtil.method17755(var21);
               ...
               if (var26 && RotationUtil.method17754(var10) > (double)var1) {
                  entities.remove();
               } else if (!this.parent.getBooleanValueFromSettingName("Through walls")) {
                  Rotations rotations = RotationUtil.getRotations(ent, true);
                  if (rotations == null) {
                     entities.remove();
                  }
               }
