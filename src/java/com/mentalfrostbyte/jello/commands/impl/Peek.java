...
public class Peek extends Command {
   ...
   public void run(String var1, ChatCommandArguments[] var2, ChatCommandExecutor var3) throws CommandException {
      if (var2.length == 0) {
         ItemStack var6 = mc.player.inventory.getCurrentItem();
         if (var6.getItem() instanceof BlockItem && ((BlockItem)var6.getItem()).getBlock() instanceof ShulkerBoxBlock) {
            method18337(var6);
   ...
   public static void method18337(ItemStack var0) {
      ...
      Inventory var6 = new Inventory(var4.toArray(new ItemStack[0]));
