...
import com.mentalfrostbyte.jello.util.unmapped.Class9819;
...
public class TP extends Command {
   ...
   public void run(String var1, ChatCommandArguments[] var2, ChatCommandExecutor var3) throws CommandException {
      if (var2.length == 0) {
      ...
      } else if (!mc.player.isOnGround() && WorldUtil.isHypixel()) {
         ...
         List<Entity> var6 = WorldUtil.getEntitesInWorld();
