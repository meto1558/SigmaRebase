...
import com.mentalfrostbyte.jello.gui.unmapped.Class4254;
import com.mentalfrostbyte.jello.managers.sound.CustomSoundPlayer;
...
public class Class4337 extends CustomGuiScreen {
   ...
   public Class4337(CustomGuiScreen var1, String var2, int var3, int var4, int var5, int var6) {
      ...
      int var9 = 0;
      this.addToList(this.field21186 = new Class4254(this, "Singleplayer", this.method13497(var9++), this.method13496(), 114, 140, Resources.singlePlayer));
      this.addToList(this.field21191 = new Class4254(this, "Multiplayer", this.method13497(var9++), this.method13496(), 114, 140, Resources.multiplayer));
      this.addToList(this.field21189 = new Class4254(this, "Options", this.method13497(var9++), this.method13496(), 114, 140, Resources.options));
      this.addToList(this.field21188 = new Class4254(this, "Language", this.method13497(var9++), this.method13496(), 114, 140, Resources.language));
      this.addToList(
         this.field21190 = new Class4254(this, "Accounts", this.method13497(var9++), this.method13496() + 140 + 10, 114, 140, Resources.accounts)
      );
