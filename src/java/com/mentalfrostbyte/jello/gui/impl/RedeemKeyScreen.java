...
public class RedeemKeyScreen extends CustomGuiScreen {
   ...
   public void draw(float var1) {
      ...
      RenderUtil.drawString(ResourceRegistry.JelloLightFont36, 100.0F, 100.0F, "Redeem Premium", ColorUtils.applyAlpha(ClientColors.LIGHT_GREYISH_BLUE.color, var1));
      ...
      RenderUtil.drawString(ResourceRegistry.JelloLightFont18, 100.0F, 263.0F, this.field21135, ColorUtils.applyAlpha(ClientColors.LIGHT_GREYISH_BLUE.color, 0.6F * var1));
      super.draw(var1);
   }
}
