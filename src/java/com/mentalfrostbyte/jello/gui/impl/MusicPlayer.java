...
public class MusicPlayer extends Class4278 {
   ...
   public MusicPlayer(CustomGuiScreen var1, String var2) {
      ...
      ColorHelper var6 = new ColorHelper(1250067, -15329770).method19410(ClientColors.LIGHT_GREYISH_BLUE.color).method19414(Class2218.field14492);
      ...
      this.pngButtons
         .addToList(
            this.play = new PNGIconButton(
               this.pngButtons, "play", var15, 27, 38, 38, Resources.playPNG, new ColorHelper(ClientColors.LIGHT_GREYISH_BLUE.color), null
            )
         );
      this.pngButtons
         .addToList(
            this.pause = new PNGIconButton(
               this.pngButtons, "pause", var15, 27, 38, 38, Resources.pausePNG, new ColorHelper(ClientColors.LIGHT_GREYISH_BLUE.color), null
            )
         );
      this.pngButtons
         .addToList(
            this.forwards = new PNGIconButton(
               this.pngButtons, "forwards", var15 + 114, 23, 46, 46, Resources.forwardsPNG, new ColorHelper(ClientColors.LIGHT_GREYISH_BLUE.color), null
            )
         );
      this.pngButtons
         .addToList(
            this.backwards = new PNGIconButton(
               this.pngButtons, "backwards", var15 - 114, 23, 46, 46, Resources.backwardsPNG, new ColorHelper(ClientColors.LIGHT_GREYISH_BLUE.color), null
            )
         );
   ...
   private void method13192(float var1) {
      ...
      RenderUtil.drawString(
         ...
         Class9275.method34955(var4),
              ColorUtils.applyAlpha(ClientColors.LIGHT_GREYISH_BLUE.color, var1 * var1)
      );
      RenderUtil.drawString(
         ResourceRegistry.JelloLightFont14,
      ...
      if (var4 != null && var5 != null) {
         ...
         RenderUtil.drawRect(
            ...
            (float)(this.getYA() + this.getHeightA() - 5),
                 ColorUtils.applyAlpha(ClientColors.DEEP_TEAL.color, 0.43F * var1)
         );
         RenderUtil.drawRect(
            (float)this.getXA(),
            (float)(this.getYA() + this.getHeightA() - 5),
   ...
   private void method13195(float var1, String var2, int var3, int var4, int var5) {
      ...
      RenderUtil.drawString(
         ...
         (float)var14,
         var2,
              ColorUtils.applyAlpha(ClientColors.LIGHT_GREYISH_BLUE.color, var1 * var1 * Math.min(1.0F, Math.max(0.0F, 1.0F - var9 * 0.75F)))
      );
      if (var9 > 0.0F) {
         RenderUtil.drawString(
            ResourceRegistry.JelloLightFont14,
   ...
   private void method13196(float var1) {
      ...
      RenderUtil.drawRect(
         ...
         (float)this.getWidthA(),
         (float)this.field20847,
              ColorUtils.applyAlpha(ClientColors.LIGHT_GREYISH_BLUE.color, var4 * var1 * 0.2F)
      );
      RenderUtil.drawString(
      ...
      RenderUtil.drawString(
         ...
         16.0F + (1.0F - var4) * 14.0F,
         this.field20849,
              ColorUtils.applyAlpha(ClientColors.LIGHT_GREYISH_BLUE.color, 1.0F - var4)
      );
      RenderUtil.drawImage(
         (float)this.field20845,
         (float)this.field20847,
         ...
         Resources.shadowBottomPNG,
              ColorUtils.applyAlpha(ClientColors.LIGHT_GREYISH_BLUE.color, var4 * var1 * 0.5F)
      );
