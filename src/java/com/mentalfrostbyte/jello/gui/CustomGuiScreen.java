...
import com.mentalfrostbyte.jello.gui.art.*;
import com.mentalfrostbyte.jello.gui.stuff.UIInput;
...
public class CustomGuiScreen implements IGuiEventListener {
    ...
    private final List<Class9781> field20922 = new ArrayList<>();
    ...
    public com.mentalfrostbyte.jello.utilities.ColorHelper textColor;
    ...
    public CustomGuiScreen(CustomGuiScreen var1, String var2, int var3, int var4, int var5, int var6) {
        this(var1, var2, var3, var4, var5, var6, com.mentalfrostbyte.jello.utilities.ColorHelper.field27961);
    }

    public CustomGuiScreen(CustomGuiScreen var1, String var2, int var3, int var4, int var5, int var6, com.mentalfrostbyte.jello.utilities.ColorHelper var7) {
        this(var1, var2, var3, var4, var5, var6, var7, null);
    }

    public CustomGuiScreen(CustomGuiScreen var1, String var2, int var3, int var4, int var5, int var6, com.mentalfrostbyte.jello.utilities.ColorHelper var7, String var8) {
        this(var1, var2, var3, var4, var5, var6, var7, var8, ResourceRegistry.JelloLightFont25);
    }

    public CustomGuiScreen(CustomGuiScreen var1, String var2, int var3, int var4, int var5, int var6, com.mentalfrostbyte.jello.utilities.ColorHelper var7, String var8, ClientResource var9) {
    ...
    public void method13028(int var1, int var2) {
        ...
        try {
            ...
            Client.getInstance().getLogger().error("FUCK! Why does this shit happen"); //What happens?
        }
    ...
    public boolean method13228(int var1, int var2, boolean var3) {
        ...
        if (var6 && this.icoPanel != null) {
            ...
            for (CustomGuiScreen var12 = this.getIcoPanel(); var12 != null; var12 = var12.getIcoPanel()) {
    ...
    public void method13243() {
        for (CustomGuiScreen var4 : this.icoPanel.method13241()) {
            if (var4 == this) {
                return;
            }
    ...
    public final CustomGuiScreen method13255(Class7381 var1) {
    ...
    public void setIcoPanel(CustomGuiScreen var1) {
        this.icoPanel = var1;
    }
    ...
    public com.mentalfrostbyte.jello.utilities.ColorHelper method13307() {
        return this.textColor;
    }

    public void method13308(com.mentalfrostbyte.jello.utilities.ColorHelper var1) {
        this.textColor = var1;
    }
