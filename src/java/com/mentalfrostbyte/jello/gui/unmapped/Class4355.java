...
public class Class4355 extends Class4247 {
   ...
   public void draw(float var1) {
      ...
      RenderUtil.renderBackgroundBox(
         (float)(this.xA + var5), (float)(this.yA + var4), 20.0F, 2.0F, ColorUtils.applyAlpha(ClientColors.DEEP_TEAL.getColor, var6)
      );
      RenderUtil.renderBackgroundBox(
         (float)(this.xA + var5), (float)(this.yA + var4 + 5), 20.0F, 2.0F, ColorUtils.applyAlpha(ClientColors.DEEP_TEAL.getColor, var6)
      );
      RenderUtil.renderBackgroundBox(
         (float)(this.xA + var5), (float)(this.yA + var4 + 10), 20.0F, 2.0F, ColorUtils.applyAlpha(ClientColors.DEEP_TEAL.getColor, var6)
      );
