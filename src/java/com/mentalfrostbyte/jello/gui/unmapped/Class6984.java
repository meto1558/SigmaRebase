...
public class Class6984 {
   ...
   public void method21598(int var1) {
      if (this.field30212 == null) {
         Client.getInstance().moduleManager.getMacOSTouchBar().method13726(var1, this.field30213);
      } else {
         Client.getInstance().moduleManager.getMacOSTouchBar().method13725(var1, this.field30212);
      }
   }
