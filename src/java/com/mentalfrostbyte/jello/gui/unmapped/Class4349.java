...
public class Class4349 extends Class4278 {
   ...
   private int field21258 = ColorUtils.method17690(ClientColors.LIGHT_GREYISH_BLUE.color, ClientColors.DEEP_TEAL.color, 20.0F);
   ...
   public void draw(float var1) {
      ...
      this.field21258 = ColorUtils.method17690(ClientColors.LIGHT_GREYISH_BLUE.color, ClientColors.DEEP_TEAL.color, 2.0F);
      if (this.field21254 || this.method13212() || this.method13298()) {
         RenderUtil.drawRect(
            ...
            ColorUtils.applyAlpha(ClientColors.LIGHT_GREYISH_BLUE.color, 0.05F)
         );
      }
      ...
      if (!this.method13212()) {
         if (this.method13298() && this.field21254) {
            RenderUtil.method11429(
               ...
               (float)(this.yA + this.heightA),
               2,
                    ColorUtils.applyAlpha(ClientColors.MID_GREY.color, 0.5F)
            );
            ...
            if (this.field21254) {
               RenderUtil.method11429(
                  ...
                  (float)(this.yA + this.heightA),
                  2,
                       ColorUtils.applyAlpha(ClientColors.MID_GREY.color, 0.3F)
               );
            }
         } else {
            RenderUtil.method11429(
         ...
         RenderUtil.method11429(
            ...
            (float)(this.yA + this.heightA),
            2,
                 ColorUtils.applyAlpha(ClientColors.MID_GREY.color, 0.65F)
         );
      }
