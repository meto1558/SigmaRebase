...
public class Class4345 extends Class4339 {
   ...
   private void method13511() {
      ...
      if (this.module instanceof ModuleWithModuleSettings) {
         ModuleWithModuleSettings var16 = (ModuleWithModuleSettings)this.module;
         ...
         var16.addClass6547((var1, var2, var3x) -> this.moduleWithSettingGuiMap.get(var2).setEnabled(var3x));
