...
public class Class4367 extends Class4247 {
   ...
   public void draw(float var1) {
      ...
      int var6 = ColorUtils.applyAlpha(ClientColors.DEEP_TEAL.color, var1);
      ...
      RenderUtil.method11432(
         ...
         this.getYA() + this.getHeightA(),
              ColorUtils.applyAlpha(ClientColors.DEEP_TEAL.color, 0.0F),
              ColorUtils.applyAlpha(ClientColors.DEEP_TEAL.color, 0.0F),
         var6,
         var6
      );
      ...
      RenderUtil.method11428(
         ...
         (float)(this.getYA() + this.getHeightA()),
              ColorUtils.applyAlpha(ClientColors.DEEP_TEAL.color, 0.25F * var1)
      );
