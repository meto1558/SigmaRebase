...
public class Class6530 implements Class6529 {
   private static String[] field28790;
   private static final float[] field28791 = new float[]{
      64.0F,
      128.0F,
      256.0F,
      512.0F,
   ...
   private static final float[] field28792 = new float[]{
      0.984615F,
      0.969697F,
      0.941176F,
      0.888889F,
   ...
   private static final float[][] field28793 = new float[][]{
   ...
   private static final float[][] field28794 = new float[][]{
   ...
   private static final float[] field28795 = new float[]{
      0.0153846F,
      0.030303F,
      0.0588235F,
      0.111111F,
   ...
   private static final float[][] field28796 = new float[][]{
      {
            0.969704F,
            0.888985F,
            0.667532F,
   ...
   private static final float[][] field28797 = new float[][]{
      {
            0.00775382F,
            0.00775945F,
            0.00778198F,
   ...
   private static final float[] field28798 = new float[]{
      2.44081E-4F,
      4.88043E-4F,
      9.7561E-4F,
      0.00194932F,
   ...
   public static void method19822(Class6528 var0, int var1) {
      for (int var4 = 0; var4 < var0.field28679[var1]; var4++) {
         if (var0.field28766[var1][var4] != 0) {
            int var6 = var4 != 0 ? var0.field28684[var1][var4 - 1] : var0.field28685[var1];
            if (var0.field28684[var1][var4] == var6) {
               for (int var11 = 0; var11 < var0.field28669[var0.field28684[var1][var4]]; var11++) {
                  int var13;
                  if (var4 != 0) {
                     var13 = var0.field28689[var1][var11][var4 - 1];
                  } else {
                     var13 = var0.field28690[var1][var11];
                  }

                  var0.field28689[var1][var11][var4] = var13 + var0.field28689[var1][var11][var4];
               }
            } else if (var6 == 1 && var0.field28684[var1][var4] == 0) {
               for (int var10 = 0; var10 < var0.field28669[var0.field28684[var1][var4]]; var10++) {
                  for (int var14 = 0; var14 < var0.field28665; var14++) {
                     if (var0.field28671[1][var14] == var0.field28671[0][var10]) {
                        int var12;
                        if (var4 != 0) {
                           var12 = var0.field28689[var1][var14][var4 - 1];
                        } else {
                           var12 = var0.field28690[var1][var14];
                        }

                        var0.field28689[var1][var10][var4] = var12 + var0.field28689[var1][var10][var4];
                     }
                  }
               }
            } else if (var6 == 0 && var0.field28684[var1][var4] == 1) {
               for (int var9 = 0; var9 < var0.field28669[var0.field28684[var1][var4]]; var9++) {
                  for (int var8 = 0; var8 < var0.field28666; var8++) {
                     if (var0.field28671[0][var8] <= var0.field28671[1][var9] && var0.field28671[1][var9] < var0.field28671[0][var8 + 1]) {
                        int var7;
                        if (var4 != 0) {
                           var7 = var0.field28689[var1][var8][var4 - 1];
                        } else {
                           var7 = var0.field28690[var1][var8];
                        }

                        var0.field28689[var1][var9][var4] = var7 + var0.field28689[var1][var9][var4];
                     }
                  }
               }
            }
         } else {
            for (int var5 = 1; var5 < var0.field28669[var0.field28684[var1][var4]]; var5++) {
               var0.field28689[var1][var5][var4] = var0.field28689[var1][var5 - 1][var4] + var0.field28689[var1][var5][var4];
               if (var0.field28689[var1][var5][var4] < 0) {
                  var0.field28689[var1][var5][var4] = 0;
               }
            }
         }
      }
   ...
   public static void method19823(Class6528 var0, int var1) {
      for (int var4 = 0; var4 < var0.field28681[var1]; var4++) {
         if (var0.field28767[var1][var4] != 0) {
            if (var4 != 0) {
               for (int var7 = 0; var7 < var0.field28667; var7++) {
                  var0.field28693[var1][var7][var4] = var0.field28693[var1][var7][var4 - 1] + var0.field28693[var1][var7][var4];
               }
            } else {
               for (int var6 = 0; var6 < var0.field28667; var6++) {
                  var0.field28693[var1][var6][var4] = var0.field28696[var1][var6] + var0.field28693[var1][var6][0];
               }
            }
         } else {
            for (int var5 = 1; var5 < var0.field28667; var5++) {
               var0.field28693[var1][var5][var4] = var0.field28693[var1][var5][var4] + var0.field28693[var1][var5 - 1][var4];
            }
         }
      }
   }

   public static float method19824(Class6528 var0, int var1, int var2, int var3) {
      if (!var0.field28756) {
         return var0.field28693[var1][var2][var3] >= 0 && var0.field28693[var1][var2][var3] <= 30 ? field28795[var0.field28693[var1][var2][var3]] : 0.0F;
      } else if (var0.field28693[0][var2][var3] < 0
         || var0.field28693[0][var2][var3] > 30
         || var0.field28693[1][var2][var3] < 0
         || var0.field28693[1][var2][var3] > 24) {
         return 0.0F;
      } else {
         return var1 != 0
            ? field28797[var0.field28693[0][var2][var3]][var0.field28693[1][var2][var3] >> 1]
            : field28796[var0.field28693[0][var2][var3]][var0.field28693[1][var2][var3] >> 1];
      }
   }

   public static float method19825(Class6528 var0, int var1, int var2, int var3) {
      if (!var0.field28756) {
         return var0.field28693[var1][var2][var3] >= 0 && var0.field28693[var1][var2][var3] <= 30 ? field28792[var0.field28693[var1][var2][var3]] : 0.0F;
      } else if (var0.field28693[0][var2][var3] < 0
         || var0.field28693[0][var2][var3] > 30
         || var0.field28693[1][var2][var3] < 0
         || var0.field28693[1][var2][var3] > 24) {
         ...
         return var1 != 0
            ? field28794[var0.field28693[0][var2][var3]][var0.field28693[1][var2][var3] >> 1]
            : field28793[var0.field28693[0][var2][var3]][var0.field28693[1][var2][var3] >> 1];
      }
   }

   public static void method19826(Class6528 var0, int var1) {
      if (!var0.field28756) {
         int var4 = !var0.field28660[var1] ? 1 : 0;

         for (int var5 = 0; var5 < var0.field28679[var1]; var5++) {
            for (int var6 = 0; var6 < var0.field28669[var0.field28684[var1][var5]]; var6++) {
               int var7 = var0.field28689[var1][var6][var5] >> var4;
               if (var7 >= 0 && var7 < 64) {
                  var0.field28691[var1][var6][var5] = field28791[var7];
                  if (var4 != 0 && (var0.field28689[var1][var6][var5] & 1) != 0) {
                     var0.field28691[var1][var6][var5] = var0.field28691[var1][var6][var5] * 1.4142135F;
                  }
               } else {
                  var0.field28691[var1][var6][var5] = 0.0F;
               }
            }
         }

         for (int var8 = 0; var8 < var0.field28681[var1]; var8++) {
            for (int var9 = 0; var9 < var0.field28667; var9++) {
               var0.field28694[var1][var9][var8] = method19824(var0, var1, var9, var8);
               var0.field28695[var1][var9][var8] = method19825(var0, var1, var9, var8);
            }
         }
      }
   }

   public static void method19827(Class6528 var0) {
      int var3 = !var0.field28660[0] ? 1 : 0;
      int var4 = !var0.field28660[1] ? 1 : 0;

      for (int var5 = 0; var5 < var0.field28679[0]; var5++) {
         for (int var6 = 0; var6 < var0.field28669[var0.field28684[0][var5]]; var6++) {
            int var7 = (var0.field28689[0][var6][var5] >> var3) + 1;
            int var8 = var0.field28689[1][var6][var5] >> var4;
            if (var7 >= 0 && var7 < 64 && var8 >= 0 && var8 <= 24) {
               float var9 = field28791[var7];
               if (var3 != 0 && (var0.field28689[0][var6][var5] & 1) != 0) {
                  var9 = (float)((double)var9 * 1.414213562);
               }

               var0.field28691[0][var6][var5] = var9 * field28798[var8];
               var0.field28691[1][var6][var5] = var9 * field28798[24 - var8];
            } else {
               var0.field28691[1][var6][var5] = 0.0F;
               var0.field28691[0][var6][var5] = 0.0F;
            }
         }
      }

      for (int var10 = 0; var10 < var0.field28681[0]; var10++) {
         for (int var11 = 0; var11 < var0.field28667; var11++) {
            var0.field28694[0][var11][var10] = method19824(var0, 0, var11, var10);
            var0.field28694[1][var11][var10] = method19824(var0, 1, var11, var10);
            var0.field28695[0][var11][var10] = method19825(var0, 0, var11, var10);
            var0.field28695[1][var11][var10] = method19825(var0, 1, var11, var10);
         }
      }
   }
}
