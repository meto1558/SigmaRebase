...
import com.mentalfrostbyte.jello.managers.impl.Class2285;
import com.mentalfrostbyte.jello.managers.impl.Class2317;
import com.mentalfrostbyte.jello.managers.impl.Class9110;
import com.mentalfrostbyte.jello.managers.impl.Class9510;
import com.mentalfrostbyte.jello.misc.Box3D;
import com.mentalfrostbyte.jello.misc.Class8627;
import com.mentalfrostbyte.jello.util.ClientColors;
import com.mentalfrostbyte.jello.util.ResourceRegistry;
import com.mentalfrostbyte.jello.util.combat.RotationUtil;
import com.mentalfrostbyte.jello.util.minecraft.BlockUtil;
...
public class Class8795 {
   ...
   public void method31745(EventEntityActionState var1) {
      if (this.method31743()) {
         if (this.field39616 == null) {
            ...
            boolean var6 = WorldUtil.isAboveBounds(this.mc.player, 0.02F);
            ...
            if (this.mc.player.getPositionVec().y % 1.0 >= 0.93) {
               var15 = var15.up();
            }
            ...
            if (var16 && !var17) {
               ...
               float var18 = RotationUtil.method34145(this.mc.player.getPositionVec(), var8.field44271.method33972())[0];
               float var19 = RotationUtil.method34145(new Vector3d(0.0, 0.0, 0.0), this.mc.player.getMotion().normalize())[0];
               float var20 = Math.abs(RotationUtil.method17756(var19, var18));
            ...
            if (var10 < var12
               && (var14 || var8.field44281.size() > 0 && (double)this.mc.player.getPosition().getY() > var8.field44271.method33970())) {
               MovementUtil.setPlayerXMotion(this.mc.player.getMotion().x * 0.5);
               MovementUtil.setPlayerZMotion(this.mc.player.getMotion().z * 0.5);
            }
            ...
            switch (var9.ordinal()) {
               case 1:
                  ...
                  if (var8.field44280 == Class2285.field15126) {
                     var38 = var10 < 1.14;
                     if (this.field39618 != null) {
                        var38 &= (double) this.mc.player.getPosition().getY() - var8.field44271.method33970() != 0.0;
                     }
                  }
      ...
      if (var1.isPre()) {
         if (this.method31743()) {
            ...
            for (long var8 : var6.field44281) {
               ...
               if (this.mc.player.getPositionVec().squareDistanceTo((double)var10.getX(), (double)var10.getY(), (double)var10.getZ()) < 9.0
            ...
            if (this.field39613 != null && this.field39613.size() > 0) {
               ...
               for (Long var8 : this.field39613.get(0).field44283) {
                  ...
                  if (!this.mc.world.getBlockState(var9).isAir()) {
                     double var10 = (double)var9.getX() - this.mc.gameRenderer.getActiveRenderInfo().getBlockPos().getX();
                     double var12 = (double)var9.getY() - this.mc.gameRenderer.getActiveRenderInfo().getBlockPos().getY();
                     double var14 = (double)var9.getZ() - this.mc.gameRenderer.getActiveRenderInfo().getBlockPos().getZ();
               ...
               for (Long var20 : this.field39613.get(0).field44284) {
                  ...
                  if (this.mc.world.getBlockState(var21).isAir()) {
                     double var22 = (double)var21.getX() - this.mc.gameRenderer.getActiveRenderInfo().getBlockPos().getX();
                     double var23 = (double)var21.getY() - this.mc.gameRenderer.getActiveRenderInfo().getBlockPos().getY();
                     double var24 = (double)var21.getZ() - this.mc.gameRenderer.getActiveRenderInfo().getBlockPos().getZ();
   ...
   public void method31753(double var1, double var3, double var5, String var7) {
      ...
      GL11.glPushMatrix();
      GL11.glTranslated(
         var1 - this.mc.gameRenderer.getActiveRenderInfo().getBlockPos().getX() + 0.5,
         var3 - this.mc.gameRenderer.getActiveRenderInfo().getBlockPos().getY(),
         var5 - this.mc.gameRenderer.getActiveRenderInfo().getBlockPos().getZ() + 0.5
      );
      GL11.glAlphaFunc(519, 0.0F);
