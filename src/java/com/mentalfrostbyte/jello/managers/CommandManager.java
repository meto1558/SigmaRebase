...
import com.mentalfrostbyte.jello.commands.impl.*;
...
public class CommandManager {
    ...
    private static final List<Runnable> field38299 = new ArrayList<>();
                ...
                if (var5.startsWith(".")) {
                    ...
                    try {
                        ...
                        if (var10.field16621.length() > 0) {
                            MinecraftUtil.addChatMessage(this.getPrefix() + " Error: " + var10.field16621);
                        }
