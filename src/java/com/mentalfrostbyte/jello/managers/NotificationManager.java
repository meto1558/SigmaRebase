...
public class NotificationManager {
    ...
    @EventTarget
    public void method31995(EventRender var1) {
        if (!Minecraft.getInstance().gameSettings.hideGUI) {
            ...
            for (int var4 = 0; var4 < this.field39919.size(); var4++) {
                ...
                int var8 = this.field39918.getMainWindow().getHeight()
                        - this.field39924
                        - this.field39925
    ...
    @EventTarget
    public void method31996(TickEvent var1) {
    ...
    private void method31998() {
        for (int var3 = 0; var3 < this.field39919.size(); var3++) {
            ...
            int var7 = this.field39918.getMainWindow().getHeight()
                    - this.field39924
                    - this.field39925
