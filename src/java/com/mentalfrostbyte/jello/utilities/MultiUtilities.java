...
public class MultiUtilities {
   ...
   public static boolean method17685(Entity var0) {
   ...
   public static void swing(Entity var0, boolean swing) {
      ...
      mc.getConnection().getNetworkManager().sendPacket(new CUseEntityPacket(var0, mc.player.isSneaking()));
   ...
   public static void method17741(int var0) {
      if (mc.gameRenderer.getShaderGroup() != null) {
         mc.gameRenderer.getShaderGroup().elements.get(0).method7410().getFromName("Radius").setValue((float)var0);
         mc.gameRenderer.getShaderGroup().elements.get(1).method7410().getFromName("Radius").setValue((float)var0);
      }
   }
