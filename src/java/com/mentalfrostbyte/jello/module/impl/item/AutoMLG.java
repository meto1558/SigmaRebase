...
import com.mentalfrostbyte.jello.util.minecraft.InvManagerUtil;
...
public class AutoMLG extends Module {
            ...
            if (/*!Client.getInstance().moduleManager.getModuleByClass(Fly.class).isEnabled()
                ...
                if (var5 != null) {
                    if (var1.isPre() && field23649 == -1) {
                        float[] var6 = RotationUtil.method34144((double) var5.getX() + 0.5, (double) var5.getZ() + 0.5, (double) var5.getY() + 0.5);
                        var1.setYaw(var6[0]);
    ...
    public int method16424() {
        ...
        if (Client.getInstance().playerStateTracker.getMode() > 1) {
            for (int var5 = 9; var5 < 36; var5++) {
                if (mc.player.container.getSlot(var5).getHasStack()) {
                    ...
                    if (var6.getItem() == Items.WATER_BUCKET) {
                        if (ViaLoadingBase.getInstance().getTargetVersion().olderThanOrEqualTo(ProtocolVersion.v1_11_1)) {
