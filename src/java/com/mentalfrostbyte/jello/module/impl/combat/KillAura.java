...
import com.mentalfrostbyte.jello.util.combat.*;
...
import com.mentalfrostbyte.jello.util.unmapped.Class9629;
...
public class KillAura extends Module {
            ...
            if (var11.func_229745_h_() && (var11.posX != 0 || var11.posY != 0 || var11.posZ != 0)) {
                for (Entry var7 : interactAB.field44349.entrySet()) {
                    ...
                    if (var11.getEntity(mc.world) == var8) {
                        Vector3d var10 = var8.getBoundingBox().getCenter().scale(2.4414062E-4F);
    ...
    public void method16828(EventUpdate var1, String var2, boolean var3) {
        ...
        boolean var9 = !Jesus.isWalkingOnLiquid() && (mc.player.isOnGround() || RotationUtil.isAboveBounds(mc.player, 0.001F));
        if (!var9) {
            this.field23941 = 0;
            this.field23940 = 0;
        } else {
    ...
    private void method16830() {
        ...
        if (var6 != null && !var6.isEmpty() && !mc.gameSettings.keyBindAttack.isPressed()) {
            ...
            if (var6.isEmpty()) {
                ...
                if (this.field23957 == -1.0F) {
                    float var7 = RotationUtil.getRotationsToVector(RotationUtil.method17751(((TimedEntity) var6.get(0)).getEntity())).yaw;
                    float var8 = Math.abs(RotationUtil.method17756(var7, previousRotations.yaw));
                ...
                entities = var6;
                float var12 = RotationUtil.getRotationsToVector(RotationUtil.method17751(entities.get(0).getEntity())).yaw;
                if (!entities.isEmpty() & !mode.equals("Switch")) {
                    if (timedEntityIdk != null && timedEntityIdk.getEntity() != entities.get(0).getEntity()) {
                        float var13 = Math.abs(RotationUtil.method17756(var12, previousRotations.yaw));
                ...
                if (!mode.equals("Switch")) {
                    ...
                    Vector3d var14 = RotationUtil.method17751(entities.get(this.field23942).getEntity());
                    float var9 = Math.abs(RotationUtil.method17756(RotationUtil.getRotationsToVector(var14).yaw, previousRotations.yaw));
    ...
    private void method16831() {
        ...
        Rotations newRots = RotationUtil.getRotations(targ, !this.getBooleanValueFromSettingName("Through walls"));
        if (newRots == null) {
            System.out.println("[KillAura] newRots is null??? on line 612");
            return;
        }
        float var5 = RotationUtil.method34152(this.rotations.yaw, newRots.yaw);
        ...
        switch (var7) {
            case "Test":
                ...
                if (Math.abs(var5) > 80.0F) {
                    ...
                    Entity var27 = RotationUtil.getEntityFromRayTrace(
                ...
                Entity var28 = RotationUtil.getEntityFromRayTrace(
                ...
                if (var28 != null && (double) this.field23947 > this.method16832(2.0, 5.0)) {
                    this.field23947 = 0;
                    MinecraftUtil.swing(var28, true);
                }
                break;
            case "NCP":
                this.rotations2.yaw = this.rotations.yaw;
            ...
            case "AAC":
                ...
                float var38 = RotationUtil.method17756(previousRotations.yaw, newRots.yaw);
                ...
                if (var29 == 0.0F || var29 >= 1.0F || (double) var35 > 0.1 && this.field23956 < 4.0F) {
                    float var41 = Math.abs(RotationUtil.method17756(newRots.yaw, previousRotations.yaw));
            ...
            case "LockView":
                this.rotations2.yaw = this.rotations.yaw;
                this.rotations2.pitch = this.rotations.pitch;
                EntityRayTraceResult ray = RotationUtil.raytrace(
                ...
                break;
            case "Test2":
                EntityRayTraceResult var24 = RotationUtil.raytrace(
                        targ, this.rotations.yaw, this.rotations.pitch, var0 -> true, this.getNumberValueBySettingName("Range")
                );
                ...
                float var22 = RotationUtil.method17756(previousRotations.yaw, newRots.yaw);
                ...
                if (var10 == 0.0F || var10 >= 1.0F || (double) var19 > 0.1 && this.field23956 < 4.0F) {
                    float var25 = Math.abs(RotationUtil.method17756(newRots.yaw, previousRotations.yaw));
