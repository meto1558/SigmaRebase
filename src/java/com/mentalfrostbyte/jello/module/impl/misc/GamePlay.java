...
public class GamePlay extends ModuleWithModuleSettings {
    public ArrayList<String> field23888 = new ArrayList<String>();
    public final ArrayList<String> field23889 = new ArrayList<String>();
    public Class7200 field23890;
    public final TimerUtil field23891;
    public int field23892;
    ...
    @EventTarget
    public void method16758(TickEvent var1) {
        if (this.isEnabled()) {
