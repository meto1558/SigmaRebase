...
public class Jesus extends Module {
      ...
      if (this.isEnabled() && mc.world != null && !AutoMLG.method16421()) {
         if (mc.world.getBlockState(var1.getBlockPos()).getMaterial() == Material.SEA_GRASS
            ...
            if (!(
               ...
               if (!this.method16951(mc.player.getBoundingBox())) {
   ...
   public void method16947(EventMove var1) {
      if (this.isEnabled() && mc.world != null && !AutoMLG.method16421()) {
         if (this.method16951(mc.player.getBoundingBox()) && !mc.player.isSneaking()) {
            BlockState var4 = mc.world.getBlockState(mc.player.getPosition());
            if (var4 != null && !var4.getFluidState().isEmpty()) {
               double var5 = (double)var4.getFluidState().getHeight();
               if (var5 > 0.4) {
                  if (this.getBooleanValueFromSettingName("Swim up")) {
                     var1.setY(0.13);
                  }

                  boolean var7 = this.method16951(mc.player.getBoundingBox().offset(0.0, var1.getY(), 0.0));
                  if (!var7) {
            ...
            if (this.getStringSettingValueByName("Mode").equals("Dolphin")) {
               if (this.field24016 > 0) {
                  if (WorldUtil.isAboveBounds(mc.player, 0.001F)) {
                     this.field24016 = 0;
                  } else {
   ...
   public boolean method16951(AxisAlignedBB var1) {
      return this.method16952(var1, Material.WATER) || this.method16952(var1, Material.LAVA);
   }
   ...
   public boolean method16952(AxisAlignedBB var1, Material var2) {
      ...
      BlockMaterialMatcher var11 = BlockMaterialMatcher.forMaterial(var2);
      return BlockPos.getAllInBox(var5, var7, var9, var6 - 1, var8 - 1, var10 - 1).anyMatch(var1x -> var11.test(mc.world.getBlockState(var1x)));
   }
