...
public class NCPStep extends Module {
    ...
    @EventTarget
    public void method16912(WorldLoadEvent var1) {
        this.field23994 = 0;
    ...
    @EventTarget
    @LowerPriority
    public void method16913(EventStep var1) {
        if (this.isEnabled() && !var1.cancelled) {
            double var4 = var1.getHeight();
            if (WorldUtil.isAboveBounds(mc.player, 1.0E-4F) && !MovementUtil.isInWater()) {
                if (var4 >= 0.625) {
    ...
    @EventTarget
    public void method16914(SafeWalkEvent var1) {
    ...
    @EventTarget
    public void method16915(SendPacketEvent var1) {
