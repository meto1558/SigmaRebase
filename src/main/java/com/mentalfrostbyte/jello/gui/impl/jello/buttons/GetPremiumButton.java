...
public class GetPremiumButton extends AnimatedIconPanelWrap {

   public GetPremiumButton(CustomGuiScreen var1, String var2, int var3, int var4, int var5, int var6) {
