...
import com.mentalfrostbyte.jello.gui.impl.jello.ingame.clickgui.objects.Slider;
...
public class SettingPanel extends ScrollableContentPanel {
    ...
    public SettingPanel(CustomGuiScreen var1, String var2, int var3, int var4, int var5, int var6, Module var7) {
    ...
    private int renderModuleSettings(CustomGuiScreen screen, Setting setting, int x, int y, int value) {
        Label name = new Label(screen, setting.getName() + "lbl", x, y, 0, 0, Label.defaultColorHelper, setting.getName(), this.settingsNameFont);
    ...
    private void method13511() {
        Label var3 = new Label(
                this, "settingsname", 12, 2, this.widthA, 20, Label.defaultColorHelper, this.module.getFormattedName() + " Settings", this.settingsNameFont
        );
        this.addToList(var3);
        int var6 = 35;
        ...
        this.addToList(new Label(this, "lbl", 5, 200, 0, 33, Label.defaultColorHelper, this.typedText));
    }
