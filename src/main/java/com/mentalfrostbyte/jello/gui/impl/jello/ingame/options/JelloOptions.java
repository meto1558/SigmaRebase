...
public class JelloOptions extends Screen {
   ...
   public void draw(float partialTicks) {
      ...
      int var6 = MathHelper.shiftTowardsOther(-1072689136, MathHelper.applyAlpha2(ClientColors.DEEP_TEAL.getColor(), 0.1F), var5);
      int var7 = MathHelper.shiftTowardsOther(-804253680, MathHelper.applyAlpha2(ClientColors.DEEP_TEAL.getColor(), 0.1F), var5);
