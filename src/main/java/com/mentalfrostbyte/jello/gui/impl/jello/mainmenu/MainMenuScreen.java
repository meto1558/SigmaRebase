    ...
    public void logout() {
        if (this.alertPanel == null) {
            this.runThisOnDimensionUpdate(() -> {
                ...
                alert.add(new AlertComponent(AlertComponent.ComponentType.HEADER, "Logout", 45));
                alert.add(new AlertComponent(AlertComponent.ComponentType.FIRST_LINE, "Are you sure?", 35));
                alert.add(new AlertComponent(AlertComponent.ComponentType.BUTTON, "Yes", 55));
