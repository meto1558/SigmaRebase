...
public class Waypoint {
   ...
   public Waypoint(String var1, int var2, int var3, int var4) {
   ...
   public Waypoint(String var1, int var2, int var3, int var4, int var5) {
      this.field35890 = var2;
   ...
   public Waypoint(JSONObject var1) throws JSONException {
      if (var1.has("name")) {
