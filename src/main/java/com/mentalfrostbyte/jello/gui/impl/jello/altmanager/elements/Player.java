...
import com.mentalfrostbyte.jello.util.game.player.EmptyClientPlayerEntity;
...
public class Player extends AnimatedIconPanelWrap {
   ...
   private EmptyClientPlayerEntity entity;

   public Player(CustomGuiScreen var1, String var2, int var3, int var4, int var5, int var6, String skinName) {
   ...
   public void draw(float partialTicks) {
      if (this.account != null) {
         ...
         if (this.entity == null || !this.entity.getDisplayName().getString().equals(this.account.getKnownName())) {
            this.entity = new EmptyClientPlayerEntity(clientWorld, new GameProfile(uid, this.account.getKnownName()));
   ...
   public static class Class7991 implements IntSupplier {
      ...
      public final Player field34349;

      public Class7991(Player var1) {
