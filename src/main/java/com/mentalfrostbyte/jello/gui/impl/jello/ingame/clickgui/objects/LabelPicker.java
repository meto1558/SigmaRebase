...
public class LabelPicker extends Element {
   ...
   public LabelPicker(CustomGuiScreen var1, String var2, int var3, int var4, int var5, int var6, boolean var7, String... var8) {
   ...
   public static class Class4372 extends Element {
