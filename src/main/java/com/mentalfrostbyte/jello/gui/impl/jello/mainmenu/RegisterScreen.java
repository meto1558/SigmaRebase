    ...
    public void method13424(String var1, String var2) {
        if (this.field21090 == null) {
            this.runThisOnDimensionUpdate(() -> {
                ...
                var5.add(new AlertComponent(AlertComponentType.HEADER, var1, 45));
                String[] var6 = RenderUtil2.method17745(var2, 240, ResourceRegistry.JelloLightFont20);

                for (int var7 = 0; var7 < var6.length; var7++) {
                    var5.add(new AlertComponent(AlertComponentType.FIRST_LINE, var6[var7], var7 != var6.length - 1 ? 14 : 35));
                }

                var5.add(new AlertComponent(AlertComponentType.BUTTON, "Ok", 55));
