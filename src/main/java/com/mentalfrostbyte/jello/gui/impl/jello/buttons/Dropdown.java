...
import com.mentalfrostbyte.jello.gui.impl.jello.ingame.clickgui.objects.DropdownSub;
...
public class Dropdown extends Element {
   ...
   private Map<Integer, DropdownSub> field21331 = new HashMap<Integer, DropdownSub>();
   ...
   public void method13643(List<String> var1, int var2) {
      DropdownSub var5 = new DropdownSub(this, "sub" + var2, this.widthA + 10, this.getHeightA() * (var2 + 1), 200, this.getHeightA(), var1, 0);
   ...
   private int method13647() {
      ...
      for (Entry var5 : this.field21331.entrySet()) {
         if (((DropdownSub)var5.getValue()).isVisible()) {
            var3 = Math.max(
               var3,
               (((DropdownSub)var5.getValue()).values.size() - 1) * ((DropdownSub)var5.getValue()).getHeightA() + ((DropdownSub)var5.getValue()).getYA()
            );
         }
      }
   ...
   public void updatePanelDimensions(int newHeight, int newWidth) {
      ...
      if (var5 >= 0
         ...
         for (Entry var9 : this.field21331.entrySet()) {
            ((DropdownSub)var9.getValue()).setEnabled((Integer)var9.getKey() == var5);
         }
         ...
         for (Entry var7 : this.field21331.entrySet()) {
            ((DropdownSub)var7.getValue()).setEnabled(false);
         }
      }
   }
   ...
   public boolean method13114(int var1, int var2) {
      for (Entry var6 : this.field21331.entrySet()) {
         if (((DropdownSub)var6.getValue()).isVisible() && ((DropdownSub)var6.getValue()).method13114(var1, var2)) {
            return true;
         }
      }
