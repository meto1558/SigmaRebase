...
//   @Override
   ...
   public void method13519(String var1, Vector3i var2, int var3) {
      ...
      if (this.content.method13221(var6) == null) {
         ...
         var7.onPress(
            var3x -> {
               Client.getInstance()
                  .waypointsManager
                  .method29993(new Waypoint(var7.field21291, var7.field21292.getX(), var7.field21292.getZ(), var7.field21293));
               this.content.method13237(var7);
         ...
         if (!var11.method13216() && this.field21211.getDirection() == Animation.Direction.FORWARDS) {
            ...
            for (Class4355 var9 : this.field21209) {
               Client.getInstance()
                  .waypointsManager
                  .getWaypoints()
                  .add(new Waypoint(var9.field21291, var9.field21292.getX(), var9.field21292.getZ(), var9.field21293));
            }
