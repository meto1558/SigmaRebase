...
public class ClassicAltScreen extends Screen {
   ...
   private Input field21066;
   private ClassicAltScreenGroup field21067;
   ...
   public ClassicAltScreen() {
      ...
      this.method13403();
      this.addToList(
         this.field21067 = new ClassicAltScreenGroup(this, "toolbar", (Minecraft.getInstance().getMainWindow().getWidth() - var9) / 2 + 16, this.getHeightA() - 94)
      );
