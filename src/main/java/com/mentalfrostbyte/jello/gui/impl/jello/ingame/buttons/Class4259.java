...
public class Class4259 extends Element {
    ...
    public void draw(float partialTicks) {
        ...
        for (Waypoint var16 : Client.getInstance().waypointsManager.getWaypoints()) {
    ...
    public static interface Class9693 {
        void method37947(Class4259 var1);
    }
}
