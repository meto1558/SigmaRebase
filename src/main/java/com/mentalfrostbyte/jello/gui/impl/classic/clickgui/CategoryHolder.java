...
import com.mentalfrostbyte.jello.gui.impl.classic.clickgui.buttons.ImageButton;
...
public class CategoryHolder extends ClickGuiPanel {
   ...
   public ImageButton field21152;
   public ImageButton field21153;
   public ImageButton field21154;
   public ImageButton field21155;
   public ImageButton field21156;
   public ImageButton field21157;

   public CategoryHolder(CustomGuiScreen var1, String var2, int var3, int var4) {
      super(var1, var2, var3 - 198, var4 - 298, 396, 596);
      this.addToList(this.field21152 = new ImageButton(this, "combat", 24, 58, 170, 130, "Combat", Resources.combat, Resources.combat2));
      this.addToList(this.field21153 = new ImageButton(this, "movement", 24, 208, 170, 130, "Movement", Resources.movement, Resources.movement2));
      this.addToList(this.field21157 = new ImageButton(this, "world", 24, 358, 170, 130, "World", Resources.world, Resources.world2));
      this.addToList(this.field21155 = new ImageButton(this, "player", 201, 58, 170, 130, "Player", Resources.player, Resources.player2));
      this.addToList(this.field21156 = new ImageButton(this, "visuals", 201, 208, 170, 130, "Visuals", Resources.visuals, Resources.visuals2));
      this.addToList(this.field21154 = new ImageButton(this, "others", 201, 358, 170, 130, "Others", Resources.others, Resources.others2));
      ExitButton var7;
      this.addToList(var7 = new ExitButton(this, "exit", this.getWidthA() - 41, 9));
