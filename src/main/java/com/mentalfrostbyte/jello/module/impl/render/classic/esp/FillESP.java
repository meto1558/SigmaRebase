...
public class FillESP extends Module {
    ...
    @EventTarget
    public void method16133(EventRender3D var1) {
        if (this.isEnabled()) {
    ...
    private void method16134() {
        ...
        for (Entity entity : mc.world.getAllEntities()) {
            if (this.method16138(entity)) {
                ...
                this.method16136(entity, var11, var13, var15, mc.timer.renderPartialTicks, var17, this.field23482);
