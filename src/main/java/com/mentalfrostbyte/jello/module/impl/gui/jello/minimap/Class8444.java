...
public class Class8444 {
    ...
    private boolean method29697() {
        Chunk var3 = MiniMap.mc.world.getChunk(this.field36184.getPos().x, this.field36184.getPos().z + 1);
        Chunk var4 = MiniMap.mc.world.getChunk(this.field36184.getPos().x, this.field36184.getPos().z - 1);
