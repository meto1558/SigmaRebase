...
public class Nuker extends Module {
    ...
    @EventTarget
    public void method16263(EventUpdate var1) {
    ...
    @EventTarget
    public void method16264(EventRender3D var1) {
        if (this.field23566 != null && !mc.world.getBlockState(this.field23566).isAir()) {
            ...
            AxisAlignedBB var11 = mc.world.getBlockState(this.field23566).getCollisionShape(mc.world, this.field23566).getBoundingBox();
    ...
    public boolean method16266(BlockPos var1) {
    ...
    public List<BlockPos> method16267(float var1) {
                    ...
                    if (!mc.world.getBlockState(var8).isAir()
                        ...
                        switch (var9) {
                            ...
                            case "Bed":
                                ...
                                break;
                            case "Egg":
                                if (!(mc.world.getBlockState(var8).getBlock() instanceof DragonEggBlock)) {
                                    continue;
                                }
                        }
