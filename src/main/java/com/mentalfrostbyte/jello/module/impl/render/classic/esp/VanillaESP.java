        ...
        if (this.isEnabled()) {
            for (Entity var5 : mc.world.getAllEntities()) {
                if (!Client.getInstance().combatManager.isTargetABot(var5)) {
                    boolean var6 = MovementUtil2.method17744(var5) == Class2258.field14690 && this.access().getBooleanValueFromSettingName("Show Players");
                    boolean var7 = MovementUtil2.method17744(var5) == Class2258.field14689 && this.access().getBooleanValueFromSettingName("Show Mobs");
                    boolean var8 = MovementUtil2.method17744(var5) == Class2258.field14691 && this.access().getBooleanValueFromSettingName("Show Passives");
