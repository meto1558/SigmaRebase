package com.mentalfrostbyte.jello.module.impl.render.jello.NameTagsUtils;
...
public class Class7070 {
   ...
   public void method21984() {
      ...
      if (this.field30450 < this.field30449 && var4 && var5 && this.field30452 > 0) {
         this.field30450 = this.field30450 + Client.getInstance().playerTracker.getPing();
      }
   ...
   public ItemStack method21985() {
      if (this.field30453 == null) {
         ...
         if (!Minecraft.getInstance().getConnection().getRecipeManager()
            ...
            for (IResourcePack var6 : Minecraft.getInstance().getResourcePackList().getEnabledPacks().stream().<IResourcePack>map(ResourcePackInfo::getResourcePack).collect(Collectors.toList())) {
               var3.addResourcePack(var6);
            }

            Class7120 var9 = new Class7120(this);
            Minecraft.getInstance().getConnection().getRecipeManager().reload((IFutureReloadListener.IStage) var9, var3, EmptyProfiler.INSTANCE, EmptyProfiler.INSTANCE, Util.getServerExecutor(), Minecraft.getInstance());
         }

         Optional<FurnaceRecipe> var7 = Minecraft.getInstance().getConnection().getRecipeManager()
            .getRecipe(IRecipeType.SMELTING, new Inventory(this.field30453), Minecraft.getInstance().world);
         if (var7.isPresent()) {
