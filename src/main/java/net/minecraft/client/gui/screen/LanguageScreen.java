...
public class LanguageScreen extends SettingsScreen
{
    ...
    public void render(MatrixStack matrices, int mouseX, int mouseY, float delta)
    {
        ...
        drawCenteredString(matrices, this.font, this.title, this.width / 2, 16, 16777215);
        drawCenteredString(matrices, this.font, field_243292_c, this.width / 2, this.height - 56, 8421504);
