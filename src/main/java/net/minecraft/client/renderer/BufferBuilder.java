...
public class BufferBuilder extends DefaultColorVertexBuilder implements IVertexConsumer
{
    ...
    public static class State
    {
        ...
        public State(ByteBuffer p_i242115_1_, VertexFormat p_i242115_2_, TextureAtlasSprite[] p_i242115_3_)
        {
            this(p_i242115_1_, p_i242115_2_);
            this.stateQuadSprites = p_i242115_3_;
        }
